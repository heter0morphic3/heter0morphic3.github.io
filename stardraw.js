...
function makeStars(){//随机生成星星数据
    for(var i=0;i<stars_count;i++)
    {
        ...
        let color="rgba("+Math.random()*255+","+Math.random()*255+","+Math.random()*255+",0.2)";
...
function drawStars(){//把星星画到画布上
    ...
    for (var i = 0; i < stars.length; i++) {
        ...
        context.fillStyle = "rgba("+Math.random()*255+","+Math.random()*255+","+Math.random()*255+",0.2)";
        context.fill();
    }
}
